...
(JNIEnv *env, jclass, jobject j_asset_manager, jstring path_to_internal_dir) {
  AAssetManager *asset_manager = AAssetManager_fromJava(env, j_asset_manager);
  return jptr(new hello_ar::HelloArApplication(env, asset_manager,path_to_internal_dir ));
}
